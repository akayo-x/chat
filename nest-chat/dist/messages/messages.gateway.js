...
__decorate([
    websockets_1.SubscribeMessage('createMessage'),
...
__decorate([
    websockets_1.SubscribeMessage('findAllMessages'),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __param(0, websockets_1.MessageBody('name')),
...
__decorate([
    ...
    __param(0, websockets_1.MessageBody('isTyping')),
    __param(1, websockets_1.ConnectedSocket()),
    __metadata("design:type", Function),
